...
sg.one_line_progress_meter(f'Downloading {y}', 0, 2, 'key','Wait...')
...
sg.one_line_progress_meter(f'Downloading {y}', 1, 2, 'key','Done!')
time.sleep(1)
sg.one_line_progress_meter(f'Downloading {y}', 2, 2, 'key','Wait...')